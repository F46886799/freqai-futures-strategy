#!/usr/bin/env python3
"""
Rebuild notebook with proper JSON structure.
Each source line must be a separate string in the array.
"""
...
with open('FreqAI_GPU_Backtest_Offline.ipynb', 'w', encoding='utf-8', newline='\n') as f:
